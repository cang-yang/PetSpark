...
public enum ErrorCode {
    ...
    VALIDATION_ENUM_001(400, "VALIDATION_ENUM_001", "枚举值非法"),
    ...
    BOARD_ROOM_CAPACITY_001(409, "BOARD_ROOM_CAPACITY_001", "房间当日容量不足"),
    BOARD_ROOM_DUPLICATE_001(409, "BOARD_ROOM_DUPLICATE_001", "房间编码已存在"),
    BOARD_DATE_INVALID_001(400, "BOARD_DATE_INVALID_001", "寄养日期范围非法"),
    BOARD_NOT_FOUND_001(404, "BOARD_NOT_FOUND_001", "寄养预约不存在或不可见"),
    BOARD_STATE_001(422, "BOARD_STATE_001", "寄养预约状态不允许该操作"),
    ROOM_NOT_FOUND_001(404, "ROOM_NOT_FOUND_001", "房间不存在或不可见"),
    ...
    // 服务/预约 404/409/422
    SERVICE_ITEM_NOT_FOUND_001(404, "SERVICE_ITEM_NOT_FOUND_001", "服务项目不存在或不可见"),
    SERVICE_RESOURCE_NOT_FOUND_001(404, "SERVICE_RESOURCE_NOT_FOUND_001", "服务资源不存在或不可见"),
    SERVICE_SLOT_NOT_FOUND_001(404, "SERVICE_SLOT_NOT_FOUND_001", "可用窗口不存在或不可用"),
    SERVICE_SLOT_UNAVAILABLE_001(409, "SERVICE_SLOT_UNAVAILABLE_001", "所选窗口已被预约或容量不足"),
    SERVICE_BOOKING_NOT_FOUND_001(404, "SERVICE_BOOKING_NOT_FOUND_001", "预约不存在或不可见"),
    SERVICE_BOOKING_STATE_001(422, "SERVICE_BOOKING_STATE_001", "预约状态不允许该操作"),
    SERVICE_PET_OWNERSHIP_001(422, "SERVICE_PET_OWNERSHIP_001", "所选宠物不属于当前用户"),

    // 社区内容 404/422
    COMMUNITY_POST_NOT_FOUND_001(404, "COMMUNITY_POST_NOT_FOUND_001", "社区帖子不存在或不可见"),
    COMMUNITY_COMMENT_NOT_FOUND_001(404, "COMMUNITY_COMMENT_NOT_FOUND_001", "社区评论不存在或不可见"),
    COMMUNITY_STATE_001(422, "COMMUNITY_STATE_001", "社区内容状态不允许该操作"),
    ...
    PET_OWNERSHIP_001(403, "PET_OWNERSHIP_001", "无权操作该宠物"),
