<template>
  <section class="my-medical-bookings">
    <h2>我的医疗预约</h2>
    <div class="toolbar">
    ...
    <el-table :data="bookings" data-testid="my-medical-bookings-table">
    ...
    <el-dialog title="医疗预约详情" :visible.sync="showDetail" width="640px" append-to-body>
      <div v-if="current" class="booking-detail">
        ...
        <p v-if="current.remark"><strong>医疗备注：</strong>{{ current.remark }}</p>
  ...
  methods: {
    ...
    async submitCancel() {
      ...
      try {
        ...
        this.current = response.data
        this.$message && this.$message.success('医疗预约已取消')
...
<style scoped>
.my-medical-bookings { max-width: 960px; margin: 24px auto; }
